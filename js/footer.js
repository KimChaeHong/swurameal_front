...
<footer class="infomation">
    <div class="cs-info">
        ...
        <div class="cs-detetail-info">
            <ul class="corp-intro">
                <li class="info"><a href="intoduce.html" class="info-link">수라소개</a></li>
                <li class="info"><a href="#" class="info-link">투자정보</a></li>
                <li class="info"><a href="#" class="info-link">인재채용</a></li>
                ...
                <li class="info"><a href="user-guide.html" class="info-link">이용안내</a></li>
            </ul>
            <div class="corp-location" id="location">
                <div>
                    ...
                    <br>
                    주소 : 서울 구로구 디지털로26길 123, 1605 ~1606호 | 대표이사 : 정원석
                    <br>
